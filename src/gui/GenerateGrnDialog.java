 ...
 */
public class GenerateGrnDialog extends javax.swing.JDialog {

    /**
     * Creates new form GenerateGrnDialog
     */
    static Logger logger = Logger.getLogger(GenerateGrnDialog.class.getName());
    
    String reportPath = "reports\\pamunuwila_hardware_salesdepartment_grn.jasper";
    Map m = new HashMap();
    int grnNumber;

    public GenerateGrnDialog(java.awt.Frame parent, boolean modal, int grnNo) {
        super(parent, modal);
        initComponents();
        logger.debug("Access to GenerateGrnDialog.java");
        
        grnNumber = grnNo;
        m.put("grn_no", grnNumber);
        try {
...
//            java.util.logging.Logger.getLogger(GenerateGrnDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int grnNo = 0;
                GenerateGrnDialog dialog = new GenerateGrnDialog(new javax.swing.JFrame(), true, grnNo);
